...
#a Project files
set_global_assignment -name VERILOG_FILE $RTL_DIR/picoriscv_project.v
...
set_global_assignment -name VERILOG_FILE $VERILOG_DIR/riscv_e32_decode.v
...
set_global_assignment -name VERILOG_FILE $VERILOG_DIR/riscv_minimal.v
set_global_assignment -name VERILOG_FILE $VERILOG_DIR/picoriscv.v
set_global_assignment -name VERILOG_FILE $VERILOG_DIR/picoriscv_clocking.v
...
set_global_assignment -name VERILOG_FILE $VERILOG_DIR/picoriscv_de1_cl.v
...
set_global_assignment -name TOP_LEVEL_ENTITY picoriscv_project

set_global_assignment -name SDC_FILE $QUARTUS_DIR/picoriscv.sdc

#a Set parameters (e.g. SRAMs)
set prv_hier "prv_micro\|prv"
set io_hier  "prv_micro\|io"
set_parameter -entity "picoriscv_project" -to "$prv_hier\|mem\|ram"                 -name initfile $SRAMS_DIR/prv.image.qmif
set_parameter -entity "picoriscv_project" -to "$prv_hier\|ftb\|character_rom\|ram"  -name initfile $SRAMS_DIR/teletext.qmif
